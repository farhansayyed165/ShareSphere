            ...
            <div className="px-6">
              <div className="flex flex-wrap justify-center">
                <div className="w-full lg:w-3/12 px-4 lg:order-2 flex justify-center relative">
                    <img alt="..." src={data.avatar} className="shadow-xl rounded-full h-auto align-middle border-none absolute -m-16 -ml-10 lg:-ml-16 max-w-[150px] " />
                </div>
                ...
                <div className="flex flex-wrap justify-center">
                  <div className="w-full lg:w-9/12 px-4">
                    <p className="mb-4 text-lg leading-relaxed text-blueGray-700">
                      {data?.about ? data.about : "Meet Farhan, a MERN Stack Web Developer with a passion for crafting dynamic and user-friendly web applications. Skilled in MongoDB, Express, React, and Node.js, Farhan creates seamless experiences that leave a lasting impact. Innovation and creativity drive his coding journey. 🚀"}
                    </p>
                  </div>
                </div>
              </div>
